...
# Examples:
User.destroy_all
Mediator.destroy_all
#
#   movies = Movie.create([{ name: 'Star Wars' }, { name: 'Lord of the Rings' }])
#   Character.create(name: 'Luke', movie: movies.first)

powers = ["Commercial", "Corporate", "Family Law", "Criminal", "Industrial Law", "Employment Law"]
powers.each do |name|
...
Mary_Pringle = Mediator.new(name: 'Mary Pringle', location: 'Melbourne', description: 'Gautama Buddha, also known as Siddhārtha Gautama, Shakyamuni Buddha, or simply the Buddha, after the title of Buddha, was a monk, mendicant, and sage, on whose teachings Buddhism was founded.', price: 50)
...
Rachael_Kelsey = Mediator.new(name: 'Rachael Kelsey', location: 'Melbourne', description: '(c. 4 BC – c. AD 30 / 33), also referred to as Jesus of Nazareth and Jesus Christ, was a first-century Jewish preacher and religious leader. He is the central figure of Christianity. Most Christians believe he is the incarnation of God the Son and the awaited Messiah (Christ) prophesied in the Old Testament.', price: 50)
...
Monica_Ross_Maranik = Mediator.new(name: 'Monica Ross Maranik', location: 'Melbourne', description: 'Ganesha (Sanskrit: गणेश, Gaṇeśa; About this sound listen (help·info)), also known as Ganapati, Vinayaka, Pillaiyar and Binayak, is one of the best-known and most worshipped deities in the Hindu pantheon.[4] His image is found throughout India, Sri Lanka, Thailand, Bali (Indonesia), Bangladesh and Nepal.[5] Hindu denominations worship him regardless of affiliations.[6] Devotion to Ganesha is widely diffused and extends to Jains and Buddhists.[7]', price: 50)
...
Sally_McGuinness = Mediator.new(name: 'Sally McGuinness', location: 'Melbourne', description: 'Ganesha (Sanskrit: गणेश, Gaṇeśa; About this sound listen (help·info)), also known as Ganapati, Vinayaka, Pillaiyar and Binayak, is one of the best-known and most worshipped deities in the Hindu pantheon.[4] His image is found throughout India, Sri Lanka, Thailand, Bali (Indonesia), Bangladesh and Nepal.[5] Hindu denominations worship him regardless of affiliations.[6] Devotion to Ganesha is widely diffused and extends to Jains and Buddhists.[7]', price: 50)
